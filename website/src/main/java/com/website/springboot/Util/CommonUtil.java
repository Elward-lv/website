...
import com.website.springboot.Util.constants.Constants;
import com.website.springboot.Util.constants.ErrorEnum;
import com.website.springboot.exception.CommonJsonException;
...
/**
 * @author: hxy
 * @description: 本后台接口系统常用的json工具类,返回json的状态信息
